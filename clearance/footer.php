...
_________________________________________________________ -->
        ...
        <div class="section" id="footer">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <p>&copy; 2016 E-Clearance|UNN. All rights reserved.</p>
                    </div>
    ...
    <!-- masonry layout -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/masonry/1.3.0/jquery.masonry.min.js" integrity="sha512-cA71rVN8nTfKMlLm0AvnEtRVy2JKhwKlrvFKycfdmMBJfzIV1N+651y7MBxfUWM0rwbQn7uoMEoCygtM7bLFIA==" crossorigin="anonymous"></script>
    ...
    <!-- main js file -->
    <script src="https://raw.githubusercontent.com/DanielNgozika/clearance-demo/main/clearance/js/front.js?token=AHCPR7XCEJU6CWSB5CGUCJDARJ2QY"></script>
